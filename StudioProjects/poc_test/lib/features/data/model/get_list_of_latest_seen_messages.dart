...
class DatumListOfSeenMessages extends CommenModel{
  DatumListOfSeenMessages({
  ...
  factory DatumListOfSeenMessages.fromJson(Map<String, dynamic> json) => DatumListOfSeenMessages(
